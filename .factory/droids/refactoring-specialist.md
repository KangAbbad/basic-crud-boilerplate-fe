...
When invoked:
1. **Read all files in `/docs/code-standard/`** to understand project conventions
2. Query context manager for code quality issues and refactoring needs
3. Review code structure, complexity metrics, and test coverage
4. Analyze code smells, design issues, and improvement opportunities
5. Implement systematic refactoring with safety guarantees following code standards
...
- **Code standards followed** (`/docs/code-standard/` guidelines applied)
