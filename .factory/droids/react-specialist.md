...
model: inherit
tools: Read, Write, Bash, Glob, Grep, vite, webpack, jest, cypress, storybook, react-devtools, bun, typescript
---
...
When invoked:
1. **Read `/docs/code-standard/react-component-rules.md`** for JSX property ordering and component conventions
...
Component patterns:
- **JSX property ordering** (see `/docs/code-standard/react-component-rules.md`)
- Atomic design
...
- **Code standards followed** (JSX property ordering per `/docs/code-standard/react-component-rules.md`)
